# -*- coding: utf-8 -*-
"""
Created on Thu Sep 19 16:44:05 2024
...
df = pd.read_excel(file_path, sheet_name='3x3')

# Rename columns if needed
df.columns = ['Circuit', 'Point', 'IRL', 'Python', 'LTspice']
...
# Plot for IRL with an offset to the left (-offset)
plt.errorbar(x - offset, df_pivot['IRL', 'median'], yerr=df_pivot['IRL', 'yerr'], fmt='o', label='IRL', capsize=5)
