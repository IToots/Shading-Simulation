# -*- coding: utf-8 -*-
"""
Created on Fri Sep 20 10:04:10 2024
...
for matrix_id, matrix in matrices.items():
    ...
    for transformed_matrix, transformed_id in transformed_matrices:
        ...
        per_power = calculate_power(transformed_matrix, ref, 'KVKH')
...
a_df_python = df[['it','base_code','SP','TCT','ST','DG','KVKH']]


# Save the final merged DataFrame to a CSV file
output_file_path = "C:/Users/ruiui/Desktop/iteration data/tabelas_pd_cumu/python_3x3_results.csv"
